...
public class PendingVoterAdapter extends RecyclerView.Adapter<PendingVoterAdapter.ViewHolder>{

    Activity activity;
    List<PhoneAddressModel.Item> arrayList;
    SelectionListner selectionListner;

    public PendingVoterAdapter(Activity activity, List<PhoneAddressModel.Item> arrayList, SelectionListner selectionListner) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (someString.length() >= 22) {
            ...
            holder.binding.otherDetails.setText(details.getHouse() + ", "+ substring+ " | Age - " + details.getAge() + " | " + details.getSex());
        } else {
            holder.binding.otherDetails.setText(someString+ " | Age - " + details.getAge() + " | " + details.getSex());
        }
